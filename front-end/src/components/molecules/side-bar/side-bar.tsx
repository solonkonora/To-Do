  ...
  return (
    ...
    >
      {dashboardElements.map((textIcon) => (
        <Link className="w-[90%] flex items-center justify-start gap-4 cursor-pointer hover:bg-secondary-color p-2 hover:rounded-sm" key={textIcon.href} href={textIcon.href}>
